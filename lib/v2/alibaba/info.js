const { company } = require('@/routes/kuaidi100/utils');
...
module.exports = async (ctx) => {
    ...
    const names = await page.$$eval("#sm-offer-list > div > div > div.mojar-element-company > div.company-name > a > div", companys => {
            return companys.map(name => name.innerText);
    });
   console.log(names)
